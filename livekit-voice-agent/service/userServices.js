...
export async function storeSupabaseEvaluation(sessionId, evaluation) {
...
export async function getSupabaseSession(sessionId) {
...
export async function endSupabaseSession(sessionId) {
    const { error } = await supabase
        .from('sessions')
        .update({
        status: 'Ended',
...
export async function getSupabaseResume(userId) {
...
export async function getSupabaseStartedAt(sessionId) {
...
export async function storeSupabaseConversation(sessionId, conversation) {
    const { error } = await supabase
        .from('messages')
        .insert([
        {
