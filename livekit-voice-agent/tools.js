...
export const evaluateResponseFunctionDeclaration = {
    ...
    description: "Score the user's evaluation scores and feedback for the user's response to the following objects inside properties. Call this silently after evaluating the user.",
    parameters: {
        type: Type.OBJECT,
        properties: {
            scores: {
